...
namespace inmobiliariaBD.Controllers
{
    ...
    public class InquilinoController : Controller
    {
        ...
        public ActionResult Index(int pagina = 1, string? busqueda = null, bool? estado = null, DateTime? desde = null, DateTime? hasta = null, string? estadoPago = null)
        {
            ...
            var inquilinos = repositorio.ObtenerPaginados(pagina, cantidadPorPagina, busqueda, estado, desde, hasta, estadoPago);
        ...
        public IActionResult Baja(int id)
        {
            ...
            var contratos = repositorioContrato.ObtenerPorInquilino(id);

            if (contratos != null && contratos.Count > 0)
            {
                TempData["Error"] = $"❌ No se puede eliminar al inquilino {inquilino.Persona.ToStringSimple()} porque tiene contratos registrados.";
                return RedirectToAction("Index");
            }
            inquilino.Persona.Dni = inquilino.Dni;
